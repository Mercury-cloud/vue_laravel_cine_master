        ...
        <div class="show_item" v-if="data.movie != null ">
            ...
            <div class="show_item__body p-md-5">
                ...
                <div class="show_item__header p-4 p-md-5 p-lg-5 p-xl-5 ">
                    ...
                    <div class="row">
                        ...
                        <div class="header__collection ml-2">
                            ...
                            <div class="add" v-if="! data.movie.is_favorite && data.movie.cloud == 'local'"
                                 @click.prevent="SHOW_COLLECTION_MODAL(data.movie.id, '/storage/backdrops/600_' + data.movie.backdrop, data.movie.name, 'movie')">

                                <img src="/themes/default/img/infavor.svg" alt="favor" width="100%">
                                <p>{{$t('show.my_collection')}}</p>
                            </div>

                            <div class="add" v-if="! data.movie.is_favorite && data.movie.cloud == 'aws'"
                                 @click.prevent="SHOW_COLLECTION_MODAL(data.movie.id, md_backdrop + data.movie.backdrop, data.movie.name, 'movie')">
                            ...
                            <div class="remove" v-if="data.movie.is_favorite"
                        ...
                        <div class="header__like ml-4">
                            ...
                            <div class="add" v-if="! data.movie.is_like"
                            ...
                            <div class="remove" v-if="data.movie.is_like"
                ...
                <div class="hidden-sm-down body__background-sm-up">
                    <img :src="'/storage/backdrops/original_' + data.movie.backdrop" :alt="data.movie.name" class="backdrop" width="100%" v-if="data.movie.cloud === 'local'">
                ...
                <div class="col-12 show_item__overview">
                    <div class="row">
                        ...
                        <div class="col-5 col-md-3 col-xl-2 mt-3 poster-sm-down">
                            <div class="poster">
                                <progressive-img :src="'/storage/posters/600_' + data.movie.poster"
                                                 placeholder="/themes/default/img/loader-image.png"
                                                 :alt="data.movie.name"
                                                 width="100%"
                                                 :aspect-ratio="1.5"
                                                 :blur="0" v-if="data.movie.cloud === 'local'"/>
                                <progressive-img :src="md_poster + data.movie.poster"
                                                 placeholder="/themes/default/img/loader-image.png"
                                                 :alt="data.movie.name"
                                                 width="100%"
                                                 :aspect-ratio="1.5"
                                                 :blur="0" v-if="data.movie.cloud === 'aws'"/>
                            </div>
                        </div>
                                            ...
                                            <div class="block ml-sm-2 m-1" v-for="(item, index) in data.casts"
                                                ...
                                                <router-link :to="{name: 'cast', params: {id: item.id}}">
                                                    <div class="image" @mouseover="castShow = item.id">
                                                        <img :src="item.image" :alt="item.name" width="100%" v-if="data.movie.cloud === 'local'"/>
                                                        <img :src="sm_cast + item.image" :alt="item.name" width="100%" v-if="data.movie.cloud === 'aws'"/>
